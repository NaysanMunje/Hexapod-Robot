...
<body>
  <div id="ui">
    ...
    <label>Stride <span class="val" id="v-stride">60 mm</span>
      <input id="stride" type="range" min="0" max="110" value="60" step="1"/>
    </label>
    ...
    <label>Turn rate <span class="val" id="v-turn">0 °/s</span>
      <input id="turn" type="range" min="-45" max="45" value="0" step="1"/>
    </label>
    <div id="status"></div>
    <div id="robot">Robot: loading…</div>
    <div id="hint">Sliders update the 3D preview only.<br/>Deploy sends params; Start runs the robot.<br/>Hip 10 mm · thigh 30 mm · shin tapers to a point.<br/>Needs internet for Three.js CDN.<br/>Drag orbit · scroll zoom</div>
  </div>
  ...
  <script type="module">
    ...
    function readUI() {
      ...
      document.getElementById('v-turn').textContent = ui.turn.value + ' °/s';
      return v;
    }
